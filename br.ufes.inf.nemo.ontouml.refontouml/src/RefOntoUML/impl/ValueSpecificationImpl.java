 ...
 * <ul>
 *   <li>{@link RefOntoUML.impl.ValueSpecificationImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ValueSpecificationImpl extends PackageableElementImpl implements ValueSpecification
{
	...
	{
		return RefOntoUMLPackage.eINSTANCE.getValueSpecification();
	}
	...
	public void setType(Type newType)
	{
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefOntoUMLPackage.VALUE_SPECIFICATION__TYPE, oldType, type));
	}
