 ...
 * <ul>
 *   <li>{@link RefOntoUML.impl.PackageImportImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link RefOntoUML.impl.PackageImportImpl#getImportedPackage <em>Imported Package</em>}</li>
 *   <li>{@link RefOntoUML.impl.PackageImportImpl#getImportingNamespace <em>Importing Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageImportImpl extends DirectedRelationshipImpl implements PackageImport
{
	 ...
	 * @ordered
	 */
	protected RefOntoUML.Package importedPackage;
	...
	{
		return RefOntoUMLPackage.eINSTANCE.getPackageImport();
	}
	...
	public void setVisibility(VisibilityKind newVisibility)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefOntoUMLPackage.PACKAGE_IMPORT__VISIBILITY, oldVisibility, visibility));
	}
	 ...
	 * @generated
	 */
	public RefOntoUML.Package basicGetImportedPackage()
	{
		return importedPackage;
	}
	 ...
	 * @generated
	 */
	public void setImportedPackage(RefOntoUML.Package newImportedPackage)
	{
		RefOntoUML.Package oldImportedPackage = importedPackage;
		importedPackage = newImportedPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTED_PACKAGE, oldImportedPackage, importedPackage));
	}
	...
	{
		if (eContainerFeatureID() != RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE) return null;
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newImportingNamespace, RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE, msgs);
		return msgs;
	}
	...
	public void setImportingNamespace(Namespace newImportingNamespace)
	{
		if (newImportingNamespace != eInternalContainer() || (eContainerFeatureID() != RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE && newImportingNamespace != null))
		{
			...
			if (newImportingNamespace != null)
				msgs = ((InternalEObject)newImportingNamespace).eInverseAdd(this, RefOntoUMLPackage.NAMESPACE__PACKAGE_IMPORT, Namespace.class, msgs);
			msgs = basicSetImportingNamespace(newImportingNamespace, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE, newImportingNamespace, newImportingNamespace));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 RefOntoUMLValidator.PACKAGE_IMPORT__PUBLIC_OR_PRIVATE,
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			case RefOntoUMLPackage.PACKAGE_IMPORT__VISIBILITY:
				...
				return;
			case RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTED_PACKAGE:
				setImportedPackage((RefOntoUML.Package)newValue);
				return;
			case RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE:
	...
	public void eUnset(int featureID)
	{
		switch (featureID)
		{
			case RefOntoUMLPackage.PACKAGE_IMPORT__VISIBILITY:
				...
				return;
			case RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTED_PACKAGE:
				setImportedPackage((RefOntoUML.Package)null);
				return;
			case RefOntoUMLPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE:
