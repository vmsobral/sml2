 ...
 * <ul>
 *   <li>{@link RefOntoUML.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementImpl extends NamedElementImpl implements TypedElement
{
	...
	{
		return RefOntoUMLPackage.eINSTANCE.getTypedElement();
	}
	...
	public void setType(Type newType)
	{
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RefOntoUMLPackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
