...
public class RelatorParticipantItemProvider
	...
	public String getText(Object object) {
		String label = "";
		if (((RelatorParticipant)object).getIsOfType() != null)
		{
			label = ((RelatorParticipant)object).getIsOfType().getName();
		}
		return label == null || label.length() == 0 ?
			getString("_UI_RelatorParticipant_type") :
			getString("_UI_RelatorParticipant_type") + " " + label;
	}
