...
//			getString("_UI_ComparativeRelation_type") + " " + label;
		...
		String label = "";
		if (((ComparativeRelation)object).getRelation() != null)
		{
			label = ((ComparativeRelation)object).getRelation().getName();
			
			String param = ((ComparativeRelation)object).getParameter();
