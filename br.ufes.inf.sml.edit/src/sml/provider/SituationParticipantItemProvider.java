...
public class SituationParticipantItemProvider
	...
	public String getText(Object object) {
		...
		if (situationParticipant.getSituationType() != null)
		{
			label = situationParticipant.getSituationType().getName();
		}
		
		String past = situationParticipant.isIsPast() ? "Past " : "";
		return label == null || label.length() == 0 ?
			past + getString("_UI_SituationParticipant_type") :
			past + getString("_UI_SituationParticipant_type") + " " + label;
	}
